package br.com.cronopedia.paginasapi.security.jwt;
...
import br.com.cronopedia.paginasapi.security.UserCredentials;
...
public class JwtLoginFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        // new UsernamePasswordAuthenticationToken(credenciais.getUsername(),
        // credenciais.getPassword()));
        return getAuthenticationManager().authenticate(
                new UsernamePasswordAuthenticationToken(credenciais.getUsername(), credenciais.getPassword()));
    }

    // Vai ser invocado caso o método attemptAuthentication seja executado sem
    // erros.
    @Override
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
            Authentication authResult) throws IOException, ServletException {
        System.out.println("Credenciado...");
        // O método generateJwtString vai inserir o Token Jwt na resposta HTTP com base
        // no nome de usuário.
