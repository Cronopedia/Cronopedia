...
public class UsuarioController {
    ...
    // // Utilizando o Response Entity para tratar os status e facilitar a exibição
    // no
    // // Front-End
    ...
    // usuarioRepository.findUsuarioByNickname(loginDoCandidato);
    ...
    // return new ResponseEntity<>(match, null, HttpStatus.MULTI_STATUS); // LEMBRAR
    // DE TRATAR NO FRONT-END
    // }

    // } catch (NoSuchElementException e) {

    // // Response - Não encontrado (404)
    // return new ResponseEntity<>(false, null, HttpStatus.NOT_FOUND); // LEMBRAR DE
    // TRATAR NO FRONT-END
    // }
    // } catch (JSONException e) {
    // // Response - Erro nas credenciais (400)
    // return new ResponseEntity<>(false, null, HttpStatus.BAD_REQUEST); // LEMBRAR
    // DE TRATAR NO FRONT-END
    // }
    ...
    // } catch (Exception e) {
    // // Response - Não encontrado (404)
    // return new ResponseEntity<>(null, HttpStatus.NOT_FOUND); // LEMBRAR DE TRATAR
    // NO FRONT-END
    // }
    // }
